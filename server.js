...
const BUNDLED_APP_ASSET = fs.readFileSync(path.join(__dirname, 'assets/index-CziOD3J3.js'), 'utf8');
const BUNDLED_STYLE_ASSET = fs.readFileSync(path.join(__dirname, 'assets/index-BUtwRDxC.css'), 'utf8');
...
app.get('/assets/index-CziOD3J3.js', (req, res) => res.type('application/javascript').send(BUNDLED_APP_ASSET));
app.get('/assets/index-BUtwRDxC.css', (req, res) => res.type('text/css').send(BUNDLED_STYLE_ASSET));
