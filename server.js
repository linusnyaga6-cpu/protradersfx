...
const BUNDLED_APP_ASSET = fs.readFileSync(path.join(__dirname, 'assets/index-x-LJezxr.js'), 'utf8');
...
app.get('/assets/index-x-LJezxr.js', (req, res) => res.type('application/javascript').send(BUNDLED_APP_ASSET));
