...
const BUNDLED_APP_ASSET = fs.readFileSync(path.join(__dirname, 'assets/index-BSUPsrmE.js'), 'utf8');
...
app.get('/assets/index-BSUPsrmE.js', (req, res) => res.type('application/javascript').send(BUNDLED_APP_ASSET));
