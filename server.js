...
const BUNDLED_APP_ASSET = fs.readFileSync(path.join(__dirname, 'assets/index-D6v1WaH5.js'), 'utf8');
...
app.get('/assets/index-D6v1WaH5.js', (req, res) => res.type('application/javascript').send(BUNDLED_APP_ASSET));
