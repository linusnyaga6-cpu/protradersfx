...
const BUNDLED_APP_ASSET = fs.readFileSync(path.join(__dirname, 'assets/index-ihs7fxKK.js'), 'utf8');
...
app.get('/assets/index-ihs7fxKK.js', (req, res) => res.type('application/javascript').send(BUNDLED_APP_ASSET));
