...
const BUNDLED_APP_ASSET = fs.readFileSync(path.join(__dirname, 'assets/index-DNNA5hMw.js'), 'utf8');
const BUNDLED_STYLE_ASSET = fs.readFileSync(path.join(__dirname, 'assets/index-BtQ-sflJ.css'), 'utf8');
...
app.get('/assets/index-DNNA5hMw.js', (req, res) => res.type('application/javascript').send(BUNDLED_APP_ASSET));
app.get('/assets/index-BtQ-sflJ.css', (req, res) => res.type('text/css').send(BUNDLED_STYLE_ASSET));
