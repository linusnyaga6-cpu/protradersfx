...
const BUNDLED_APP_ASSET = fs.readFileSync(path.join(__dirname, 'assets/index-CPxAmB7q.js'), 'utf8');
...
app.get('/assets/index-CPxAmB7q.js', (req, res) => res.type('application/javascript').send(BUNDLED_APP_ASSET));
