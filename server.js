...
const BUNDLED_APP_ASSET = fs.readFileSync(path.join(__dirname, 'assets/index-CC9AjHoK.js'), 'utf8');
...
app.get('/assets/index-CC9AjHoK.js', (req, res) => res.type('application/javascript').send(BUNDLED_APP_ASSET));
