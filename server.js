...
const BUNDLED_APP_ASSET = fs.readFileSync(path.join(__dirname, 'assets/index-ClmLtrJf.js'), 'utf8');
const BUNDLED_STYLE_ASSET = fs.readFileSync(path.join(__dirname, 'assets/index-CKdEgvjJ.css'), 'utf8');
...
app.get('/assets/index-ClmLtrJf.js', (req, res) => res.type('application/javascript').send(BUNDLED_APP_ASSET));
app.get('/assets/index-CKdEgvjJ.css', (req, res) => res.type('text/css').send(BUNDLED_STYLE_ASSET));
